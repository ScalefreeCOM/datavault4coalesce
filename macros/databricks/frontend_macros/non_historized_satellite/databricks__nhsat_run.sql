...
{#-- Utility macro: outputs a SQL function to run a Non-historized satellite table. --#}
{%- macro datavault4coalesce__databricks_non_historized_satellite_run(node, columns) -%}
