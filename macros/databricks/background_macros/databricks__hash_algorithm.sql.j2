...
{#--                                                                                         --#}
{#-- Outputs hashing algorithm and Databricks function to calculate hashes based on  --#}
...
{#---------------------------------------------------------------------------------------------#}
{%- macro datavault4coalesce__databricks_hash_algorithm(hash_function=none, hash_datatype=none) -%}
