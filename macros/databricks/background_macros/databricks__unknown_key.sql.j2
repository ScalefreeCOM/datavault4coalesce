...
{#---------------------------------------------------------------------------------------------#}
{%- macro datavault4coalesce__databricks_unknown_key(hash_function=none, hash_datatype=none) -%}
     ...
     {% set unknown_key = datavault4coalesce__databricks_as_constant(unknown_key) %}
     {{ unknown_key }}
