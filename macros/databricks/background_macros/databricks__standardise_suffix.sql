...
{%- macro datavault4coalesce__databricks_standardise_suffix(case_sensitive, hash_alg, is_hashdiff, datatype, zero_key, alias, multi_active_key, main_hashkey_col) -%}
{%- set dict_result = {} -%}
{%- set ldts_alias = datavault4coalesce.config.ldts_alias -%}
{%- set zero_key = datavault4coalesce__databricks_as_constant(column_str=zero_key) -%}
{%- set listagg_closing = "" -%}
