...
{#---------------------------------------------------------------------------------------------#}
{%- macro datavault4coalesce__databricks_error_key(hash_function=none, hash_datatype=none) -%}
     ...
     {% set error_key = datavault4coalesce__databricks_as_constant(error_key) %}
     {{ error_key }}
{%- endmacro -%}